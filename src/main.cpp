...
#if defined(NDEBUG)
# error "Antoinettecoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x5ade6ecdfbf6753822d7414434cb300f7c1ce68c686648ba94c87ff12da48765");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Antoinettecoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Antoinettecoin Signed Message:\n";
...
{
    // Antoinettecoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
static const int64 nTargetTimespan = 60; // Antoinettecoin: 1 minute
static const int64 nTargetSpacing = 30; // Antoinettecoin: 30 seconds
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Antoinettecoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Antoinettecoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x5ade6ecdfbf6753822d7414434cb300f7c1ce68c686648ba94c87ff12da48765");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "AntoinetteCoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 2 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("432184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1518991693;
        ...
        assert(block.hashMerkleRoot == uint256("0x6a6ea62f37011c504b7aba035c12dd794349271ed14d6d49f70c9435fb372048"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfa, 0xc3, 0xb1, 0xdd }; // Antoinettecoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("AntoinettecoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("AntoinettecoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static AntoinettecoinMiner(CWallet *pwallet)
{
    printf("AntoinettecoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("antoinettecoin-miner");
    ...
    try { loop {
        ...
        printf("Running AntoinettecoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("AntoinettecoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&AntoinettecoinMiner, pwallet));
}
